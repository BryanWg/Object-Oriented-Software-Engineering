...
public class AddressBookApp
{
    ...
    private static AddressBook readAddressBook(String fileName) throws IOException
    {
        ...
        while(line != null)
        {
            ...
            addressBook.addKVP2(entry.getEmailOne(), entry);
            if(entry.getEmailTwo() != null)
            {
                addressBook.addKVP2(entry.getEmailTwo(), entry);
            }
...
*******************************************************************************/
    ...
    * **********************************************************************/
    public static Entry processLine(String[] line)
    {
        ...
        if(line.length == 3)
        {
            entry = new Entry(line[0], line[1], line[2]);
        }
        else if(line.length == 2)
        {
//System.out.println("Here");
            entry = new Entry(line[0], line[1]);
        }
        else
        {
            throw new IllegalArgumentException("Can only hold max of two email");
        }
